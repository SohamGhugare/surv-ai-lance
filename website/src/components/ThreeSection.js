  ...
  return (
    <div className="threeSectionContainer">
      <div className="threeSectionTextContainer">
        ...
        <p className="threeSectionText">The best possible use of AI there possibly could be is helping people stay safe. At <span className="coloredText underline threeTextWord">Surv-AI-lance</span>, That is our mission.</p>
      </div>
        <ThreeModel />
    </div>
  )
